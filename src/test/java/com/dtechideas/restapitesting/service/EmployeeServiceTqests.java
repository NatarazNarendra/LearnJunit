...
public class EmployeeServiceTqests {
	 ...
	 * Employee("Dhandapani","Sudhakar","dhandapani.sudhakar@dtechideas.com");
	 * Employee employee2 = new
	 * Employee("Kathirvel","Sudhakar","kathirvel.sudhakar@dtechideas.com");
	 * given(employeeRepository.findAll()).willReturn(List.of(employee1,employee2));
	 * // when - action or the behaviour List<Employee> employees =
	 * employeeService.getAllEmployees(); // then - verify the output
	 * assertThat(employees).isNotNull(); assertThat(employees.size()).isEqualTo(2);
	 * }
	 */
